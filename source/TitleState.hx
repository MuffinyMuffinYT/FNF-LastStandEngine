	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['Last Stand Engine by'], 15);
					#else
				...
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('MuffinyMuffinYT', 15);
					addMoreText('CresentMoony', 15); //ORIGINAL PSYCH BY SHADOWMARIO, RIVEROAKEN (hi river) AND SHUBS
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
